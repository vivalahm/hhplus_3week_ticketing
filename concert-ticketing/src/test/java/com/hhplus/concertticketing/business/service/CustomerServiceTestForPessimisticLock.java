...
public class CustomerServiceTestForPessimisticLock {
    ...
    void chargePoint_success() {
        ...
        when(customerRepository.getCustomerByIdWithLock(customerId)).thenReturn(Optional.of(customer));
    ...
    void chargePoint_notFound() {
        ...
        when(customerRepository.getCustomerByIdWithLock(customerId)).thenReturn(Optional.empty());
